...
export const SpeechBubbleDown = ({ children }: SpeechBubbleProps) => {
  return (
    // 부모 div는 자식 요소들의 위치 기준점(relative)이 됩니다.
    // inline-block을 추가하여 내용만큼의 크기를 갖도록 합니다.
    <div className={`relative inline-block w-[239px] h-[139px]`}>
      {/* 1. 배경이 될 말풍선 이미지 */}
      <Image
        src="/images/speech-bubble-down.svg"
        alt="Speech Bubble"
        width={239} // width는 정수값 사용을 권장합니다.
      ...
      <div className="absolute inset-0">
        <div className="text-center w-full h-[116px] flex items-center justify-center">
